            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                	<?php
						...
						$query = "select distinct emailid, cartid from tabsold where cartid in (select cartid from tabdeliver)";
						...
						if (mysql_num_rows($result) > 0)
						{
							...
							while($record = mysql_fetch_array($result))
							{
								...
								echo '<td align="right"><a href="opendeliver.php?CartID=' . $record[1] . '" type="button" class="btn btn-primary">Open</a></td>';
								echo '</tr>';
							}
							echo '</table>';
						}
